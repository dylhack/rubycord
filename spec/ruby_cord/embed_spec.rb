...
RSpec.describe RubyCord::Embed do
  ...
  it "sets color" do
    expect(
      described_class.new("t", "d", color: RubyCord::Color[:blue]).to_hash
    ).to eq(
      {
        title: "t",
        description: "d",
        color: RubyCord::Color[:blue].to_i,
        type: "rich"
      }
    )
  end
  ...
  it "adds non-inline field" do
    expect(
      described_class.new(
        "t",
        "d",
        fields: [RubyCord::Embed::Field.new("name", "value", inline: false)]
      ).to_hash
    ).to eq(
      {
        title: "t",
  ...
  it "adds inline field" do
    expect(
      described_class.new(
        "t",
        "d",
        fields: [RubyCord::Embed::Field.new("name", "value", inline: true)]
      ).to_hash
    ).to eq(
      {
        title: "t",
  ...
  describe "image" do
    ...
    it "sets image by initialize argument with Image class" do
      expect(
        described_class.new(
          "t",
          "d",
          image: RubyCord::Embed::Image.new("url")
        ).to_hash
      ).to eq(result)
    end
    ...
    it "sets image by #image= with Image class" do
      ...
      embed.image = RubyCord::Embed::Image.new("url")
  ...
  describe "thumbnail" do
    ...
    it "sets thumbnail by initialize argument with Thumbnail class" do
      expect(
        described_class.new(
          "t",
          "d",
          thumbnail: RubyCord::Embed::Thumbnail.new("url")
        ).to_hash
      ).to eq(result)
    end
    ...
    it "sets thumbnail by #thumbnail= with Thumbnail class" do
      embed = described_class.new("t", "d")
      embed.thumbnail = RubyCord::Embed::Thumbnail.new("url")
      expect(embed.to_hash).to eq(result)
    end
    ...
    it "sets author by initialize argument" do
      expect(
        described_class.new(
          ...
          "d",
          author:
            RubyCord::Embed::Author.new("name", url: "url", icon: "icon_url")
        ).to_hash
      ).to eq(
        {
          type: "rich",
  ...
  describe "footer" do
    it "sets footer by initialize argument" do
      expect(
        described_class.new(
          "t",
          "d",
          footer: RubyCord::Embed::Footer.new("text", icon: "icon_url")
        ).to_hash
      ).to eq(
        {
          type: "rich",
    ...
    it "sets footer by #footer=" do
      embed = described_class.new("t", "d")
      embed.footer = RubyCord::Embed::Footer.new("text", icon: "icon_url")
