...
RSpec.describe RubyCord::Component do
  let(:button) { RubyCord::Component::Button.new("label", :primary, custom_id: "id") }
  let(:select_menu) { RubyCord::Component::SelectMenu.new("id", []) }
