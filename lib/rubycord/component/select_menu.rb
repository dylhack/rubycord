...
module RubyCord
  ...
  class Component
    class SelectMenu < Component
      ...
      # @param [Array<RubyCord::Component::SelectMenu::Option>] options The options of the select menu.
      ...
      class << self
        ...
        #
        # @return [RubyCord::Component::SelectMenu] The created select menu.
        #
        def from_hash(data)
          new(
            data[:custom_id],
      ...
      class Option
        ...
        # @return [RubyCord::Emoji] The emoji of the option.
        attr_accessor :emoji
        ...
        # @param [RubyCord::Emoji] emoji The emoji of the option.
        ...
        class << self
          ...
          #
          # @return [RubyCord::Component::SelectMenu::Option] A new option.
          #
          def from_hash(data)
            new(
              data[:label],
