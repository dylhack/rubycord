...
module RubyCord
  ...
  #
  class Guild
    class ForumChannel < RubyCord::Guild::Channel
      ...
      # @return [Array<RubyCord::Guild::ForumChannel::Tag>] The tags in the channel.
      attr_reader :tags
      ...
      class Tag < RubyCord::DiscordModel
        ...
        # @return [RubyCord::Emoji] The emoji of the tag.
        attr_reader :emoji
        ...
        # @param [RubyCord::Emoji] emoji The emoji of the tag.
        # @param [Boolean] moderated Whether the tag is moderated. (aka moderator only)
        #
        # @return [RubyCord::Guild::ForumChannel::Tag] The new tag.
        #
      ...
      #
      class Post < RubyCord::Guild::ThreadChannel
        @channel_type = 11

        # @return [Array<RubyCord::Guild::ForumChannel::Tag>] The tags of the post.
        attr_reader :tags
        ...
        # @param [Array<RubyCord::Guild::ForumChannel::Tag>] tags The tags of the thread.
        #
        ...
        # @async
        #
        # @param [Array<RubyCord::Guild::ForumChannel::Tag>] tags The tags to add.
        ...
        # @async
        #
        # @param [Array<RubyCord::Guild::ForumChannel::Tag>] tags The tags to remove.
      ...
      # @param [RubyCord::Emoji] default_reaction_emoji The default reaction emoji of the channel.
      # @param [:latest_activity, :creation_date] default_sort_order The default sort order of the channel.
      # @param [Array<RubyCord::Guild::ForumChannel::Tag>] tags The tags of the channel.
      ...
      # @async
      #
      # @param [Array<RubyCord::Guild::ForumChannel::Tag>] tags The tags to create.
      ...
      # @async
      #
      # @param [Array<RubyCord::Guild::ForumChannel::Tag>] tags The tags to delete.
      ...
      # @param [Array<RubyCord::Guild::ForumChannel::Tag>] tags The tags to attach.
      ...
      # @param [Integer] slowmode Alias of `rate_limit_per_user`.
      #
      # @return [Async::Task<RubyCord::Guild::ForumChannel::Post>] The created thread.
      #
      def create_post(
        title,
        content = nil,
