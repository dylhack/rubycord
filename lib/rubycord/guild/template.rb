...
module RubyCord
  ...
  #
  class Guild
    class Template < RubyCord::DiscordModel
      ...
      # @return [RubyCord::User] The user who created this template.
      attr_reader :creator
      # @return [Time] The time this template was created.
      attr_reader :created_at
      # @return [Time] The time this template was last updated.
      attr_reader :updated_at
      # @return [RubyCord::Snowflake] The ID of guild where the template was created.
      attr_reader :source_guild_id
      # @return [RubyCord::Guild::Template::TemplateGuild] The guild where the template was created.
      ...
      #   @macro client_cache
      #   @return [RubyCord::Guild] The guild this template is based on.
      ...
      #
      def edit(name = nil, description = RubyCord::Unset)
        Async do
          payload = {}
          payload[:name] = name if name
          payload[:description] = description if description != RubyCord::Unset
          @client
            .http
            .request(
      ...
      #
      class TemplateGuild < RubyCord::DiscordModel
        # @return [String] The name of the guild.
        attr_reader :name
        # @return [Integer] The AFK timeout of the guild.
        attr_reader :afk_timeout
        # @return [RubyCord::Internal::Dictionary{RubyCord::Snowflake => RubyCord::Role}] A dictionary of roles in the guild.
        attr_reader :roles
        # @return [RubyCord::Guild::SystemChannelFlag] The flag for the system channel.
        attr_reader :system_channel_flags
        # @return [RubyCord::Internal::Dictionary{RubyCord::Snowflake => RubyCord::Guild::Channel}]
        ...
        def initialize(data)
          ...
          @region = data[:region]
          @verification_level =
            RubyCord::Guild::MFA_LEVELS[data[:verification_level]]
          @default_message_notifications =
            RubyCord::Guild::NOTIFICATION_LEVELS[
              data[:default_message_notifications]
            ]
          @explicit_content_filter =
            RubyCord::Guild::EXPLICIT_CONTENT_FILTERS[
          ...
          @system_channel_flags =
            RubyCord::Guild::SystemChannelFlag.new(data[:system_channel_flags])
        end
        ...
        class Channel < RubyCord::DiscordModel
          ...
          def initialize(data)
            ...
            @type =
              RubyCord::Channel.descendants.find do |c|
