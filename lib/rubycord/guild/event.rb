...
module RubyCord
  ...
  #
  class Guild
    class Event < RubyCord::DiscordModel
      # @private
      ...
      # @return [RubyCord::Snowflake] The ID of the event.
      attr_reader :id
      ...
      # @return [RubyCord::Snowflake] The ID of the entity the event is for.
      attr_reader :entity_id
      # @return [RubyCord::Guild::Event::Metadata] The metadata of the event.
      attr_reader :metadata
      # @return [Integer] The user count of the event.
      attr_reader :user_count

      # @!attribute [r] guild
      #   @return [RubyCord::Guild, nil] The guild of the event.
      # @!attribute [r] channel
      #   @return [RubyCord::Channel, nil] The channel of the event.
      #     Only present if the event will do in stage instance or voice channel.
      # @!attribute [r] creator
      #   @return [RubyCord::User] The user who created the event.#
      # @!attribute [r] time
      ...
      #
      # @return [Async::Task<RubyCord::Guild::Event>] The event that was created.
      #
      # @see Event#start
      # @see Event#cancel
      # @see Event#complete
      ...
      def edit(
        ...
        start_time: RubyCord::Unset,
        end_time: RubyCord::Unset,
        privacy_level: RubyCord::Unset,
        location: RubyCord::Unset,
        channel: RubyCord::Unset,
        status: RubyCord::Unset
      )
        Async do
          payload =
            case type == RubyCord::Unset ? @entity_type : type
            when :stage_instance
              unless channel
                raise ArgumentError,
...

              {
                ...
                status:
                  RubyCord::Guild::Event::STATUS.key(status) || RubyCord::Unset
              }.reject { |_, v| v == RubyCord::Unset }
            when :voice
              unless channel
      ...
      #
      # @return [Async::Task<Array<RubyCord::Guild::Member>>] The event users.
      #
        ...
        Async do
          if limit.nil?
            ...
            loop do
              ...
              res +=
                users.map do |u|
                  RubyCord::Guild::Member.new(@client, @guild_id, u[:user], u[:member])
                end
            ...
            params =
              {
                limit:,
                before: RubyCord::Utils.try(before, :id),
                after: RubyCord::Utils.try(after, :id),
                with_member:
