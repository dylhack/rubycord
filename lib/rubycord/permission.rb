...
module RubyCord
  ...
  class PermissionOverwrite
    # @!attribute [r] allow
    #   @return [RubyCord::Permission] The allowed permissions.
    # @!attribute [r] deny
    #   @return [RubyCord::Permission] The denied permissions.
    ...
    #
    # @param [RubyCord::PermissionOverwrite] other The other permission overwrite.
    #
    # @return [RubyCord::PermissionOverwrite] The union of the permission overwrites.
    #
    def +(other)
      result = to_hash
    ...
    class << self
      ...
      #
      # @return [RubyCord::PermissionOverwrite] The permission overwrite.
      #
      def from_hash(hash)
        allow = 0
        deny = 0
