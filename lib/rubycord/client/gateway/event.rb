...
module RubyCord
  class Client
    module Gateway
      ...
      class Event
        #
        # Initializes a new instance of the Gateway::Event class.
        # @private
        #
        ...
        class ReactionEvent < Event
          ...
          attr_reader :data
          # @return [RubyCord::Snowflake] The ID of the user who reacted.
          attr_reader :user_id
          alias member_id user_id
          # @return [RubyCord::Snowflake] The ID of the channel the message was sent in.
          attr_reader :channel_id
          # @return [RubyCord::Snowflake] The ID of the message.
          attr_reader :message_id
          # @return [RubyCord::Snowflake] The ID of the guild the message was sent in.
          attr_reader :guild_id
          # @macro client_cache
          # @return [RubyCord::User, RubyCord::Guild::Member] The user who reacted.
          attr_reader :user
          alias member user
          # @macro client_cache
          # @return [RubyCord::Channel] The channel the message was sent in.
          attr_reader :channel
          # @macro client_cache
          # @return [RubyCord::Guild] The guild the message was sent in.
          attr_reader :guild
          # @macro client_cache
          # @return [RubyCord::Message] The message the reaction was sent in.
          attr_reader :message
          # @return [RubyCord::UnicodeEmoji, RubyCord::PartialEmoji] The emoji that was reacted with.
          attr_reader :emoji
        ...
        class IntegrationDeleteEvent < Event
          ...
          # @!attribute [r] guild
          #   @macro client_cache
          #   @return [RubyCord::Guild] The guild of the integration.
          # @!attribute [r] user
          #   @macro client_cache
          #   @return [RubyCord::User] The user associated with the integration.

          #
          # Initialize a new instance of the Client::Gateway::Event::IntegrationDeleteEvent class.
          # @private
          #
          #
          # @param [Hash] data The data of the event.
        ...
        class ReactionRemoveAllEvent < Event
          ...
          #
          # Initialize a new instance of the Client::Gateway::Event::ReactionRemoveAllEvent class.
          # @private
          #
          # @param [RubyCord::Client] client The client that instantiated the object.
          # @param [Hash] data The data of the event.
        ...
        class ReactionRemoveEmojiEvent < Event
          ...
          #
          # Initialize a new instance of the Client::Gateway::Event::ReactionRemoveEmojiEvent class.
          # @private
          #
          # @param [RubyCord::Client] client The client that instantiated the object.
          # @param [Hash] data The data of the event.
        ...
        class ScheduledEventUserEvent < Event
          # @return [RubyCord::User] The user that triggered the event.
          attr_reader :user
          # @return [RubyCord::Guild] The guild the event was triggered in.
          attr_reader :guild
          # @return [RubyCord::Guild::Event] The scheduled event.
          attr_reader :scheduled_event

          #
          # Initialize a new instance of the Client::Gateway::Event::ScheduledEventUserEvent class.
          # @private
          #
          # @param [RubyCord::Client] client The client that instantiated the object.
          # @param [Hash] data The data of the event.
        ...
        class MessageUpdateEvent < Event
          # @return [RubyCord::Message] The message before update.
          attr_reader :before
          # @return [RubyCord::Message] The message after update.
          attr_reader :after
          # @return [RubyCord::Snowflake] The ID of the message.
          attr_reader :id
          # @return [RubyCord::Snowflake] The ID of the channel the message was sent in.
          ...
          # @macro client_cache
          # @return [Array<RubyCord::Guild::Role>] The roles mentioned in the message.
          attr_reader :mention_roles
          # @return [Array<RubyCord::Attachment>] The attachments in the message.
          attr_reader :attachments
          # @return [Array<RubyCord::Embed>] The embeds in the message.
          attr_reader :embeds
        ...
        #
        class UnknownDeleteBulkMessage < Event
          # @return [RubyCord::Snowflake] The ID of the message.
          attr_reader :id
          ...
          #
          # Initialize a new instance of the Client::Gateway::Event::UnknownDeleteBulkMessage class.
          # @private
          #
          # @param [RubyCord::Client] client The client that instantiated the object.
          # @param [Hash] data The data of the event.
        ...
        class InviteDeleteEvent < Event
          ...
          #
          # Initialize a new instance of the Client::Gateway::Event::InviteDeleteEvent class.
          # @private
          #
          # @param [RubyCord::Client] client The client that instantiated the object.
          # @param [Hash] data The data of the event.
        ...
        class TypingStartEvent < Event
          # @return [RubyCord::Snowflake] The ID of the channel the user is typing in.
          attr_reader :user_id

          # @!attribute [r] channel
          #   @macro client_cache
          #   @return [RubyCord::Channel] The channel the user is typing in.
          # @!attribute [r] guild
          #   @macro client_cache
          #   @return [RubyCord::Guild] The guild the user is typing in.
          # @!attribute [r] user
          #   @macro client_cache
          #   @return [RubyCord::User, RubyCord::Guild::Member] The user that is typing.

          #
          # Initialize a new instance of the Client::Gateway::Event::TypingStartEvent class.
          # @private
          #
          # @param [RubyCord::Client] client The client that instantiated the object.
          # @param [Hash] data The data of the event.
        ...
        #
        class MessagePinEvent < Event
          # @return [RubyCord::Message] The message that was pinned.
          attr_reader :message
        ...
        class WebhooksUpdateEvent < Event
          # @!attribute [r] channel
          #   @macro client_cache
          #   @return [RubyCord::Channel] The channel where the webhook was updated.
          # @!attribute [r] guild
          #   @macro client_cache
          #   @return [RubyCord::Guild] The guild where the webhook was updated.

          #
          # Initialize a new instance of the Client::Gateway::Event::WebhooksUpdateEvent class.
          # @private
          #
          # @param [RubyCord::Client] client The client that instantiated the object.
          # @param [Hash] data The data of the event.
        ...
        class AutoModerationActionExecutionEvent < Event
          ...
          # @return [RubyCord::Snowflake] The id of the message that triggered the action.
          # @return [nil] If the message was deleted.
          attr_reader :message_id

          # @return [RubyCord::Snowflake] The id of the system message that was sent.
          ...
          # @return [RubyCord::Guild::AutoModRule::Action] The action that was executed.
          attr_reader :action
          ...
          def initialize(client, data)
            ...
            @rule_trigger_type =
              RubyCord::Guild::AutoModRule::TRIGGER_TYPES[data[:rule_trigger_type]]
            @action = RubyCord::Guild::AutoModRule::Action.new(data[:action])
            @user_id = Snowflake.new(data[:user_id])
            @guild_id = Snowflake.new(data[:guild_id])
          ...
          # @!attribute [r] guild
          #   @return [RubyCord::Guild] The guild where the rule was executed.
          def guild
            @client.guilds[@guild_id]
          end

          # @!attribute [r] channel
          #   @return [RubyCord::Channel] The channel where the rule was executed.
          def channel
            @client.channels[@channel_id]
          end

          # @!attribute [r] member
          #   @return [RubyCord::Guild::Member] The member that triggered the action.
          def member
            guild.members[@user_id]
          end
