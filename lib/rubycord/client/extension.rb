...
module RubyCord
  ...
  class Client
    module Extension
      ...
      #
      module ClassMethods
        include RubyCord::Client::CommandHandler
        ...
        # @return [Hash{Symbol => Array<RubyCord::EventHandler>}] The events of the extension.
        attr_reader :events
        # @return [Array<RubyCord::Command>] The commands of the extension.
