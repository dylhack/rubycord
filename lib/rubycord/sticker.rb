...
module RubyCord
  ...
  #
  class Sticker < RubyCord::DiscordModel
    # @return [RubyCord::Snowflake] The ID of the sticker.
    attr_reader :id
    ...
    # @return [RubyCord::Snowflake] The ID of the sticker pack.
    attr_reader :pack_id
    # @return [Integer] The sort value of the sticker.
    attr_reader :sort_value
    # @return [RubyCord::Snowflake] The ID of the guild the sticker is in.
    attr_reader :guild_id
    # @return [RubyCord::User] The user who created the sticker.
    attr_reader :user
    ...
    class GuildSticker < Sticker
      # @!attribute [r] guild
      #   @macro client_cache
      #   @return [RubyCord::Guild] The guild the sticker is in.
      ...
      # @param [RubyCord::Emoji] tag The new tags of the sticker.
    ...
    #
    class Pack < RubyCord::DiscordModel
      # @return [RubyCord::Snowflake] The ID of the sticker pack.
      attr_reader :id
      # @return [String] The name of the sticker pack.
      attr_reader :name
      # @return [RubyCord::Snowflake] The cover sticker of the pack.
      attr_reader :cover_sticker_id
      # @return [String] The description of the pack.
      attr_reader :description
      # @return [Array<RubyCord::Sticker>] The stickers in the pack.
      attr_reader :stickers
      # @return [RubyCord::Asset] The banner of the pack.
      attr_reader :banner
