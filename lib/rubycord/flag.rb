...
module RubyCord
  ...
  class Flag
    ...
    # Union of two flags.
    #
    # @param [RubyCord::Flag] other The other flag.
    #
    # @return [RubyCord::Flag] The union of the two flags.
    #
    def |(other)
    ...
    # @param [RubyCord::Flag] other The other flag.
    #
    # @return [RubyCord::Flag] The subtraction of the two flags.
    #
    def -(other)
    ...
    # @param [RubyCord::Flag] other The other flag.
    #
    # @return [RubyCord::Flag] The intersection of the two flags.
    #
    def &(other)
      self.class.new(@value & other.value)
    end
    ...
    # @param [RubyCord::Flag] other The other flag.
    #
    # @return [RubyCord::Flag] The XOR of the two flags.
    #
    def ^(other)
      self.class.new(@value ^ other.value)
    end
    ...
    #
    # @return [RubyCord::Flag] The negation of the flag.
    #
    def ~
