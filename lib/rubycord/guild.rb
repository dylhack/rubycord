...
module RubyCord
  ...
  class Guild < RubyCord::DiscordModel
    ...
    # @return [RubyCord::Snowflake] ID of the guild.
    attr_reader :id
    # @return [String] The name of the guild.
    attr_reader :name
    # @return [RubyCord::Asset] The splash of the guild.
    attr_reader :splash
    # @return [RubyCord::Asset] The discovery splash of the guild.
    attr_reader :discovery_splash
    # @return [RubyCord::Snowflake] ID of the guild owner.
    attr_reader :owner_id
    # @return [RubyCord::Permission] The bot's permission in the guild.
    attr_reader :permissions
    # @return [Integer] The AFK timeout of the guild.
    attr_reader :afk_timeout
    # @return [RubyCord::Internal::Dictionary{RubyCord::Snowflake => RubyCord::Guild::Role}] A dictionary of roles in the guild.
    attr_reader :roles
    # @return [RubyCord::Internal::Dictionary{RubyCord::Snowflake => RubyCord::CustomEmoji}]
    ...
    # @return [RubyCord::Guild::SystemChannelFlag] The flag for the system channel.
    ...
    attr_reader :icon
    # @return [RubyCord::Internal::Dictionary{RubyCord::User => Guild::VoiceChannel::VoiceState}] A dictionary of voice states in the guild.
    attr_reader :voice_states
    # @return [RubyCord::Internal::Dictionary{RubyCord::Snowflake => RubyCord::Guild::Member}] A dictionary of members in the guild.
    # @macro members_intent
    attr_reader :members
    # @return [RubyCord::Internal::Dictionary{Snowflake => RubyCord::Guild::Channel}] A dictionary of channels in the guild.
    attr_reader :channels
    # @return [RubyCord::Internal::Dictionary{Snowflake => RubyCord::Guild::ThreadChannel}] A dictionary of threads in the guild.
    attr_reader :threads
    # @return [RubyCord::Internal::Dictionary{RubyCord::User => RubyCord::Presence}] A dictionary of presence in the guild.
    ...
    # @return [RubyCord::Asset] The banner of the guild.
    ...
    # @return [RubyCord::Guild::WelcomeScreen] The welcome screen of the guild.
    attr_reader :welcome_screen
    # @return [:default, :explicit, :safe, :age_restricted] The nsfw level of the guild.
    attr_reader :nsfw_level
    # @return [RubyCord::Internal::Dictionary{RubyCord::Snowflake => RubyCord::StageInstance}]
    ...
    # @return [Internal::Dictionary{Snowflake => RubyCord::Guild::Event}] A dictionary of scheduled events in the guild.
    attr_reader :scheduled_events
    alias events scheduled_events

    # @!attribute [r] afk_channel
    #   @return [RubyCord::Guild::VoiceChannel] The AFK channel for this guild.
    #   @macro client_cache
    # @!attribute [r] system_channel
    #   @return [RubyCord::Guild::TextChannel] The system message channel for this guild.
    #   @macro client_cache
    # @!attribute [r] rules_channel
    #   @return [RubyCord::Guild::TextChannel] The rules channel for this guild.
    #   @macro client_cache
    # @!attribute [r] public_updates_channel
    #   @return [RubyCord::Guild::TextChannel] The public updates channel (`#moderator-only`) for this guild.
    #   @macro client_cache
    # @!attribute [r] me
    #   @return [RubyCord::Guild::Member] The client's member in the guild.
    ...
    # @private
    #
    # @param [RubyCord::Client] client The client that owns this guild.
    ...
    #   Defaults to `true`.
    #
    # @return [Array<RubyCord::Guild::Event>] The events for the guild.
    #
    ...
    #
    # @return [Async::Task<RubyCord::Guild::Event>] The event with the given ID.
    ...
    # @param [RubyCord::Channel, RubyCord::Snowflake, nil] channel The channel to run the event in.
    ...
    #
    # @return [Async::Task<RubyCord::Guild::Event>] The created event.
    #
      ...
      Async do
        payload =
          ...
          when :stage_instance
...

            {
              ...
              privacy_level:
                RubyCord::Guild::Event::PRIVACY_LEVEL.key(privacy_level),
              channel_id: channel&.id,
              entity_type:
                RubyCord::Guild::Event::ENTITY_TYPE.key(:stage_instance)
            }
          when :voice
            unless channel
...

            {
              ...
              privacy_level:
                RubyCord::Guild::Event::PRIVACY_LEVEL.key(privacy_level),
              channel_id: channel&.id,
              entity_type: RubyCord::Guild::Event::ENTITY_TYPE.key(:voice)
            }
          when :external
            unless location
              raise ArgumentError,
...

            {
              ...
              privacy_level:
                RubyCord::Guild::Event::PRIVACY_LEVEL.key(privacy_level),
              entity_type: RubyCord::Guild::Event::ENTITY_TYPE.key(:external),
              entity_metadata: {
                location:
              }
            }
        ...
        _resp, event =
          @client
            ...
            .wait
        RubyCord::Guild::Event.new(@client, event)
      end
    end
    ...
    #
    # @return [Async::Task<RubyCord::Internal::Dictionary{RubyCord::Snowflake => RubyCord::CustomEmoji}>]
      ...
      Async do
        _resp, data =
          @client
            ...
            .wait
        @emojis = Internal::Dictionary.new
    ...
    #
    # @return [Async::Task<RubyCord::CustomEmoji>] The emoji with the given id.
    #
    def fetch_emoji(id)
      Async do
        _resp, data =
    ...
    # @param [RubyCord::Image] image The image of the emoji.
    # @param [Array<RubyCord::Guild::Role>] roles A list of roles to give the emoji.
    #
    # @return [Async::Task<RubyCord::CustomEmoji>] The created emoji.
    #
          ...
          @client
            ...
            .request(
              ...
              ),
              {
                name:,
                image: image.to_s,
                roles: roles.map { |r| RubyCord::Utils.try(r, :id) }
              }
            )
            .wait
    ...
    # @async
    #
    # @return [Async::Task<Array<RubyCord::Guild::Webhook>>] A list of webhooks in the guild.
    #
    def fetch_webhooks
      Async do
        _resp, data =
    ...
    # @async
    #
    # @return [Async::Task<RubyCord::Guild::AuditLog>] The audit log of the guild.
    #
    def fetch_audit_log
      Async do
        _resp, data =
          @client
            ...
            .wait
        Guild::AuditLog.new(@client, data, self)
      end
    end
    ...
    # @async
    #
    # @return [Async::Task<Array<RubyCord::Channel>>] A list of channels in the guild.
    #
    def fetch_channels
      Async do
        _resp, data =
    ...
    # @param [Hash{RubyCord::Guild::Role, RubyCord::Guild::Member => RubyCord::PermissionOverwrite}] permission_overwrites
    #   A list of permission overwrites.
    # @param [RubyCord::Guild::CategoryChannel] parent The parent of the channel.
    ...
    def create_text_channel(
      ...
      Async do
        payload = { type: RubyCord::Guild::TextChannel.channel_type }
        payload[:name] = name
        ...
        if permission_overwrites
          payload[
            ...
            {
              type: target.is_a?(RubyCord::Guild::Role) ? 0 : 1,
              id: target.id,
    ...
    def create_voice_channel(
      ...
      Async do
        payload = { type: RubyCord::Guild::VoiceChannel.channel_type }
        payload[:name] = name
    ...
    # @param [String] reason The reason for creating the channel.
    #
    # @return [Async::Task<RubyCord::Guild::CategoryChannel>] The created category channel.
    #
    def create_category_channel(
      ...
      Async do
        payload = { type: RubyCord::Guild::CategoryChannel.channel_type }
        payload[:name] = name
        payload[:position] = position if position
        if permission_overwrites
          payload[
    ...
    def create_stage_channel(
      ...
      Async do
        payload = { type: RubyCord::Guild::StageChannel.channel_type }
        payload[:name] = name
        payload[:bitrate] = bitrate * 1000 if bitrate
        payload[:position] = position if position
        if permission_overwrites
    ...
    def create_news_channel(
      ...
      Async do
        payload = { type: RubyCord::Guild::NewsChannel.channel_type }
        payload[:name] = name
        payload[:topic] = topic if topic
        rate_limit_per_user ||= slowmode
        payload[
    ...
    # @async
    #
    # @return [Async::Task<Array<RubyCord::Guild::ThreadChannel>>] The list of threads.
    #
    ...
    #
    # @return [Async::Task<RubyCord::Guild::Member>] The member.
    ...
    def fetch_member(id)
      Async do
        ...
        RubyCord::Guild::Member.new(@client, @id, data[:user], data)
      end
    end
    ...
    #
    # @return [Async::Task<Array<RubyCord::Guild::Member>>] The list of members.
    #
        ...
        unless limit.zero?
          _resp, data =
            @client
              ...
              .wait
          next data[:members].map { |m| RubyCord::Guild::Member.new(@client, @id, m[:user], m) }
        end
        ret = []
        after = 0
        loop do
          ...
          _resp, data =
            @client
              ...
              .wait
          ret += data.map { |m| RubyCord::Guild::Member.new(@client, @id, m[:user], m) }
      ...
      Async do
        _resp, data =
          @client
            ...
            .wait
        data.map { |d| RubyCord::Guild::Member.new(@client, @id, d[:user], d) }
      end
    end
    ...
    # @async
    #
    # @param [RubyCord::Guild::Member] member The member to kick.
    ...
    # @param [RubyCord::Snowflake] before The ID of the ban to fetch before.
    # @param [RubyCord::Snowflake] after The ID of the ban to fetch after.
    # @param [RubyCord::Snowflake] around The ID of the ban to fetch around.
    #
    # @return [Async::Task<Array<RubyCord::Guild::Ban>>] The list of bans.
    #
    ...
    # @async
    #
    # @param [RubyCord::User] user The user to fetch.
    #
    ...
    # @async
    #
    # @param [RubyCord::User] user The user to check.
    #
    ...
    # @async
    #
    # @param [RubyCord::Guild::Member] member The member to ban.
    ...
    # @async
    #
    # @param [RubyCord::User] user The user to unban.
    ...
    # @async
    #
    # @return [Async::Task<Array<RubyCord::Guild::Role>>] The list of roles.
    #
    def fetch_roles
      Async do
        _resp, data =
          @client
            ...
            .wait
        data.map { |d| RubyCord::Guild::Role.new(@client, self, d) }
      end
    end
    ...
    # @param [RubyCord::Color] color The color of the role.
    ...
    #
    # @return [Async::Task<RubyCord::Role>] The role.
    #
    def create_role(
      name = nil,
      color: nil,
    ...
    # @param [Array<RubyCord::Guild::Role>] roles The roles that include for pruning.
    #
    ...
    # @async
    #
    # @return [Async::Task<Array<RubyCord::VoiceRegion>>] The available voice regions.
    #
      ...
      Async do
        _resp, data =
          @client
            ...
            .wait
        data.map { |d| guild::invite.new(@client, d, false) }
      end
    end
    ...
    # @async
    #
    # @return [Async::Task<Array<RubyCord::Integration>>] The integrations.
    #
    ...
    # @async
    #
    # @return [Async::Task<RubyCord::Guild::Widget>] The widget.
    #
    def fetch_widget
      Async do
        _resp, data =
    ...
    # @async
    #
    # @return [Async::Task<RubyCord::Guild::VanityInvite>] The vanity URL.
    #
      ...
      Async do
        _resp, data =
          @client
            ...
            .wait
        Guild::VanityInvite.new(@client, self, data)
      end
    end
    ...
    # @async
    #
    # @return [Async::Task<RubyCord::Guild::WelcomeScreen>] The welcome screen.
    #
    ...
    # @async
    #
    # @return [Async::Task<Array<RubyCord::Sticker::GuildSticker>>] The stickers.
    #
    def fetch_stickers
      Async do
        _resp, data =
    ...
    #
    # @return [Async::Task<RubyCord::Sticker::GuildSticker>] The sticker.
    ...
    # @async
    #
    # @return [Async::Task<RubyCord::Guild::Template>] The templates.
    #
    def fetch_templates
      Async do
        _resp, data =
          @client
            ...
            .wait
        data.map { |d| Guild::Template.new(@client, d) }
      end
    end
    ...
    #
    # @return [RubyCord::Guild::Template] The template.
    ...
    #
    # @return [Async::Task<RubyCord::Guild::Template>] The template.
    #
      ...
      Async do
        _resp, data =
          @client
            ...
            .wait
        Guild::Template.new(@client, data)
      end
    end
    ...
    # @async
    #
    # @return [Async::Task<Array<RubyCord::Guild::AutoModRule>>] The automod rules.
    #
    def fetch_automod_rules
      Async do
        ...
        data.map { |d| Guild::AutoModRule.new(@client, d) }
      end
    end
    ...
    #
    # @return [Async::Task<Array<RubyCord::Guild::AutoModRule>>] The automod rule.
    #
      ...
      Async do
        _resp, data =
          @client
            ...
            .wait
        Guild::AutoModRule.new(@client, data)
      end
    end
    ...
    # @param [Symbol] trigger_type The trigger type of the rule. See {RubyCord::Guild::AutoModRule::TRIGGER_TYPES}.
    ...
    #
    # @return [Async::Task<RubyCord::Guild::AutoModRule>] The automod rule.
    #
    def create_automod_rule(
      ...
      Async do
        payload = {
          name:,
          event_type: RubyCord::Guild::AutoModRule::EVENT_TYPES.key(event_type),
          trigger_type: RubyCord::Guild::AutoModRule::TRIGGER_TYPES.key(trigger_type),
          metadata: {
            keyword_filter:,
            presets: presets && RubyCord::Guild::AutoModRule::PRESET_TYPES.key(presets),
            allow_list:,
            mention_total_limit:
          },
        ...
        RubyCord::Guild::AutoModRule.new(@client, data)
      end
    end
    ...
    class << self
      ...
      def banner(guild_id, style: :banner)
        "#{RubyCord::API_BASE_URL}/guilds/#{guild_id}/widget.png&style=#{style}"
      end
    end
    ...
    def _set_data(data, is_create_event)
      ...
      @unavailable = false
      @name = data[:name]
      @members = RubyCord::Internal::Dictionary.new
      data[:members]&.each { |m| RubyCord::Guild::Member.new(@client, @id, m[:user], m) }
      @splash =
        ...
        Internal::Dictionary.new(
          data[:voice_states].to_h do |v|
            [
              ...
              Guild::VoiceChannel::VoiceState.new(@client, v.merge({ guild_id: @id }))
            ]
          end
        )
      @threads =
      ...
      @stage_instances =
        Internal::Dictionary.new(
          data[:stage_instances].to_h do |s|
            [Snowflake.new(s[:id]), rubycord::guild::stagechannel::stageinstance.new(@client, s)]
          end
        )
      @scheduled_events =
        Internal::Dictionary.new(
...
require_relative "guild/ban"
require_relative "guild/voice_region"
require_relative "guild/template"
require_relative "guild/automod_rule"
require_relative "guild/channel"
require_relative "guild/system_channel_flag"
require_relative "guild/invite"
require_relative "guild/member"
require_relative "guild/vanity_invite"
require_relative "guild/role"
require_relative "guild/event"
require_relative "guild/webhook"
require_relative "guild/welcome_screen"
require_relative "guild/widget"

  # include Guild::Role
  # include Guild::Ban
  # include Guild::Member
  # include Guild::Webhook
  # include Guild::CategoryChannel
  # include Guild::TextChannel
  # include Guild::NewsChannel
  # include Guild::ForumChannel
  # include Guild::VoiceChannel
  # include Guild::VoiceRegion
  # include Guild::StageChannel
  # include Guild::WelcomeScreen
